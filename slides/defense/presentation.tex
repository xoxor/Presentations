...
%	}
	...
	\begin{itemize}
		\item eliciting preferences of agents and chair incrementally and simultaneously
...
\begin{frame}
	...
	\[\argmin_{\allalts}(\sigma~\circ~\lambda_P)=\{\includegraphics[scale=0.025]{assets/d2.png}\} \quad \forall \sigma \in \Sigma\]
\end{frame}
...
\begin{frame}
	...
	\end{theorem}
	\onslide<2-> $f \in \text{ECC} \Rightarrow \includegraphics[scale=0.025]{assets/d2.png} \in f(\prof)$, $f \in \text{Paretian} \Rightarrow \includegraphics[scale=0.025]{assets/d2.png} \notin f(\prof)$
\end{frame}
